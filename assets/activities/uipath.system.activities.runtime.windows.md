...
Assembly: UiPath.System.Activities v25.4.4.0
PackageVersion: 25.4.4
ActivityCount: 266
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **AutosubmitTimeoutSeconds** : Int32 [Plain]  // Segundos do tempo limite para envio automático
  - **Credential** : UiPath.Core.Activities.PasswordCredentials [Out]  // Credencial
- optional:
  - CredentialName : String [Plain]  // NomeDaCredencial
  - OrchestratorCredentialName : String [In]  // Nome da credencial do Orchestrator
  - TimeoutInSeconds : Int32 [In]  // Tempo limite (em segundos)
  - OrchestratorFolderPath : String [In]  // Pasta do Orchestrator
  - CredentialsSource : UiPath.Activities.CredentialSource [Plain]  // Origem das credenciais
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
## UiPath.Core.Activities.AskWhenRun`1
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - Result : TResult [Out]
  - ResultType : Type [Plain]
...
## UiPath.Core.Activities.AskWhenRunDialog
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - Result : UiPath.Core.GenericValue [Plain]

## UiPath.Core.Activities.AssetValueType
- xmlns: `http://schemas.uipath.com/workflow/activities`

## UiPath.Core.Activities.AssignOperation
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - Value : ? [In]
  - To : ? [Out]
...
- optional:
  ...
  - Arguments : Collections.Generic.Dictionary<String,Activities.InArgument> [Plain]  // Argumentos
  - UsePackage : Boolean [Plain]  // Usar pacote
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **TableInfo** : String [Plain]  // InformaçõesDaTabela
- optional:
...
## UiPath.Core.Activities.ButtonOptions
- xmlns: `http://schemas.uipath.com/workflow/activities`

## UiPath.Core.Activities.CacheStrategyEnum
- xmlns: `http://schemas.uipath.com/workflow/activities`

## UiPath.Core.Activities.ChangeType`1
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **SourceValue** : Object [In]  // Variável a alterar
  - **ConvertedValue** : T [Out]  // Salvar nova variável como
- optional:
  - Format : IFormatProvider [Plain]  // Formato
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
## UiPath.Core.Activities.CreateList`1
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **NewList** : Collections.Generic.IList<T> [Out]  // Nova lista
- optional:
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
## UiPath.Core.Activities.EnableDisableRefactoringCore
- xmlns: `http://schemas.uipath.com/workflow/activities`
...
## UiPath.Core.Activities.EnterCredentialsWindow
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - ShouldRememberCredentials : Boolean [Plain]
...
## UiPath.Core.Activities.ExecutePowerShell
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - ContinueOnError : Boolean [In]  // Continue On Error
  - CommandText : String [In]  // TextoDeComando
  - Parameters : Collections.Generic.IDictionary<String,Activities.InArgument> [Plain]  // Parâmetros
  - Input : Collections.ObjectModel.Collection<Management.Automation.PSObject> [In]  // Input
  - PipelineOutput : Collections.ObjectModel.Collection<Management.Automation.PSObject> [Out]  // SaídaDoPipeline
  - Errors : Collections.ObjectModel.Collection<Management.Automation.ErrorRecord> [Out]  // Erros
  - IsScript : Boolean [Plain]  // ÉScript
  - PowerShellVariables : Collections.Generic.IDictionary<String,Activities.Argument> [Plain]  // VariáveisDoPowerShell
  - PowerShellProcess : UiPath.Core.Activities.PowerShellProcessVersion [Plain]  // Modo de execução
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
## UiPath.Core.Activities.FileChangeTrigger
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **Path** : String [In]  // Caminho
- optional:
  - FileName : String [In]  // Nome do Arquivo
  - NotifyFilters : IO.NotifyFilters [Plain]  // FiltrosDeNotificação
  - ChangeType : IO.WatcherChangeTypes [Plain]  // AlterarTipo
  - IncludeSubdirectories : Boolean [Plain]  // IncluirSubdiretórios
  - DisplayName : String [Plain]
  - Id : String [Plain]

## UiPath.Core.Activities.FileChangeTriggerArgs
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - FileChangeInfo : UiPath.Core.FileChangeInfo [Plain]

## UiPath.Core.Activities.FileChangeTriggerV2
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **Path** : String [In]  // Caminho
- optional:
  ...
  - ChangeType : IO.WatcherChangeTypes [Plain]  // AlterarTipo
  - IncludeSubdirectories : Boolean [Plain]  // IncluirSubdiretórios
  - ContinueMonitoring : Activities.Activity<Boolean> [Plain]  // ContinuarMonitoramento
  - ContinueOnError : Boolean [In]  // Continue On Error
...
- required:
  - **Path** : String [In]  // Caminho
  - **NotifyFilters** : IO.NotifyFilters [In]  // FiltrosDeNotificação
  - **ChangeType** : IO.WatcherChangeTypes [In]  // AlterarTipo
- optional:
  - FileNameFilter : String [In]  // Filtro NomeDoArquivo
  - IncludeSubdirectories : Boolean [In]  // IncluirSubdiretórios
...
- optional:
  ...
  - FilterRowsMode : UiPath.Core.Activities.SelectMode [In]  // ModoDeFiltrarLinhas
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **Folder** : String [In]  // Na pasta
- optional:
  - IncludeSubDirectories : Boolean [Plain]  // IncluirSubdiretórios
  - SkipFolderWithoutPermission : Boolean [Plain]  // Ignorar pastas com acesso negado
  - Filter : String [In]  // Filter
  - OrderBy : UiPath.Core.Activities.ForEachFileOrderByOptions [Plain]  // Ordenar
  - Body : Activities.ActivityAction<IO.FileInfo,Int32> [Plain]
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- optional:
  ...
  - SkipFoldersWithoutPermission : Boolean [Plain]  // Ignorar pastas com acesso negado
  - FilterByName : String [In]  // Filtrar por nome
  - OrderBy : UiPath.Core.Activities.ForEachFolderOrderByOptions [Plain]  // Ordenar por
  - Body : Activities.ActivityAction<IO.DirectoryInfo,Int32> [Plain]
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **Value** : UiPath.Core.GenericValue [InOut]  // Valor
- optional:
  - Format : IFormatProvider [Plain]  // Formato
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **SpecialFolder** : Environment/SpecialFolder [Plain]  // Pasta Especial
- optional:
  - FolderPath : String [Out]  // Caminho da Pasta
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **Variable** : String [In]  // Variável
- optional:
  - VariableValue : String [Out]  // ValorDaVariável
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **FilePath** : String [In]  // Caminho
- optional:
  - Output : IO.FileInfo [Out]  // Saída em
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **FolderPath** : String [In]  // Caminho
- optional:
  - ThrowIfNotExists : Boolean [Plain]  // Throw If Not Exists
  - Output : IO.DirectoryInfo [Out]  // SaídaEm
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - Processes : Collections.ObjectModel.Collection<Diagnostics.Process> [Out]  // Processos
  - ContinueOnError : Boolean [In]  // Continue On Error
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - ConditionBlocks : ComponentModel.BindingList<UiPath.Core.Activities.IfElseIfBlock> [Plain]
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- optional:
  ...
  - Label : String [In]  // Rótulo
  - Options : String[] [In]  // Opções
  - OptionsString : String [In]  // String de Opções
  - IsPassword : Boolean [Plain]  // ÉSenha
  - TopMost : Boolean [In]  // Superior
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - MethodName : String [In]  // NomeDoMétodo
  - ProgID : String [In]  // ProgID
  - CLSID : String [In]  // CLSID
  - BindingFlags : Reflection.BindingFlags [Plain]  // SinalizadoresDeAssociação
  - Arguments : Collections.Generic.Dictionary<String,Activities.Argument> [Plain]  // Argumentos
  - ContinueOnError : Boolean [In]  // Continue On Error
  - Result : TResult [Out]
  - ResultType : Type [Plain]
...
## UiPath.Core.Activities.InvokePowerShell`1
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - Parameters : Collections.Generic.Dictionary<String,Activities.InArgument> [Plain]  // Parâmetros
  - PowerShellVariables : Collections.Generic.Dictionary<String,Activities.Argument> [Plain]  // VariáveisDoPowerShell
  - CommandText : String [In]  // TextoDeComando
  - Input : Collections.ObjectModel.Collection<Management.Automation.PSObject> [In]  // Input
  - IsScript : Boolean [Plain] = false  // ÉScript
  - PowerShellProcess : UiPath.Core.Activities.PowerShellProcessVersion [Plain]  // Modo de execução
  - Output : Collections.ObjectModel.Collection<TResult> [Out]  // Saída
  - ContinueOnError : Boolean [In]  // Continue On Error
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **FileName** : String [In]  // NomeDoArquivoDoVBScript
- optional:
  - TimeoutMS : Int32 [In]  // Tempo Limite
  - RunInBatchMode : Boolean [In]  // OcultarPopups
  - WaitForOutput : Boolean [In]  // AguardarSaída
  - KillOnTimeout : Boolean [In]  // EncerrarAoAtingirTempoLimite
  - UnicodeSupport : Boolean [In]  // CompatívelComUnicode
  - Arguments : Collections.Generic.List<Activities.InArgument<String>> [Plain]  // Argumentos
  - Result : String [Out]  // Resultado
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- required:
  - **WorkflowFileName** : String [In]  // WorkflowFileName
- optional:
  - KeepSessionConnected : Boolean [Plain]  // ManterSessãoConectada
  - LoginToConsole : Boolean [Plain]  // LogonNoConsole
  - Width : Int32 [Plain]  // Largura
  - Height : Int32 [Plain]  // Altura
  - Depth : Int32 [Plain]  // Profundidade
  - TargetSession : UiPath.Core.Activities.InvokeWorkflowTargetSession [Plain] = 0  // TargetSession
  - UnSafe : Boolean [Plain]  // Isolado
  - AssemblyName : String [Plain]
  - ContinueOnError : Boolean [In]  // Continue On Error
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **ProcessName** : String [In]  @group=ProcessName  // NomeDoProcesso
  - **Process** : Diagnostics.Process [In]  @group=Process  // Processo
- optional:
  - AppliesTo : UiPath.Core.Activities.KillProcessApplyOn [In] = 0  // AplicávelA
  - ContinueOnError : Boolean [In]  // Continue On Error
  - DisplayName : String [Plain]
  - Id : String [Plain]

## UiPath.Core.Activities.KillProcessApplyOn
- xmlns: `http://schemas.uipath.com/workflow/activities`
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- required:
  - **Text** : Object [In]  // Texto
- optional:
  - AutoCloseAfter : TimeSpan [In]  // FecharAutomaticamenteApós
  - Buttons : UiPath.Core.Activities.ButtonOptions [In]  // Botões
  - Caption : String [In]  // Legenda
  - TopMost : Boolean [In]  // Superior
  - ChosenButton : String [Out]  // BotãoEscolhido
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - AssignOperations : Collections.Generic.List<UiPath.Core.Activities.AssignOperation> [Plain]
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
## UiPath.Core.Activities.PowerShellProcessVersion
- xmlns: `http://schemas.uipath.com/workflow/activities`
...
- optional:
  - KeepExtension : Boolean [Plain]  // Manter extensão
  - DisplayName : String [Plain]
  - Id : String [Plain]
...
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - Filter : String [Plain]  // Filter
  - InitialDirectory : String [In]  // Diretório inicial
  - Multiselect : Boolean [In]  // Seleção múltipla
  - SelectedFile : String [Out]  // Arquivo Selecionado
  - SelectedFiles : Collections.Generic.IEnumerable<String> [Out]  // Arquivos selecionados
  - DisplayName : String [Plain]
  - Id : String [Plain]

## UiPath.Core.Activities.SelectFileOptions
- xmlns: `http://schemas.uipath.com/workflow/activities`

## UiPath.Core.Activities.SelectFolder
- xmlns: `http://schemas.uipath.com/workflow/activities`
- optional:
  - SelectedFolder : String [Out]  // PastaSelecionada
  - DisplayName : String [Plain]
  - Id : String [Plain]
